...
# --- 1. PERMANENT ACCOUNTS (ADD HERE FOR RENDER FREE TIER) ---
DEFAULT_ACCOUNTS = [
...
DATA_DIR = "data"
os.makedirs(DATA_DIR, exist_ok=True) # Fixed the crash error
...
# Auto-login check (Prevents password asking on manual refresh)
if st.query_params.get("login") == "success":
...
# Auto-refresh timer for 2 minutes
st_autorefresh(interval=120 * 1000, key="auto_refresh")

# --- 5. AESTHETICS (STRICTLY PRESERVED) ---
st.markdown("""
    <style>
